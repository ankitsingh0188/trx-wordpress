...
Displays a collection of audio tracks as an audio album using the native WordPress audio features. v1.3.0 incudes a customizer section.
...
`[audioalbum]`
This shortcode is optional and can be used as a header before the `[audiotrack]` shortcodes.
