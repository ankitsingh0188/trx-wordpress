<?php
   ...
   Plugin URI: http://www.thedevcorner.com/tools/wp-fast-cache.php 
...
/* stuff to do when we create plugin */
      ...
      if($_SERVER['REQUEST_METHOD']=='POST'){
        ...
        if($_POST['wp_fast_cache_bulk_action']=="cache_all_categories"){
          ...
          if($_POST['wp_fast_cache_bulk_action']=="cache_this_url"){
              ...
              $bulk_url = $page_uri . '/listings/' . $value['code'];
  ...
  <hr style="border:0px;border-top: 1px solid #ccc;margin:5px 0px;">
      ...
      <tr>
      <td style="padding:8px;"> <input style="width:460px;" type="hidden" id="wp_fast_cache_specific_url" name="wp_fast_cache_specific_url"> </td>
