 ...
 */
function rock_star_excerpt_desired( $num ) {
    $limit = $num+1;
...
if ( ! function_exists( 'rock_star_continue_reading' ) ) :
	...
	function rock_star_continue_reading() {
		...
		return ' <span class="read-more"><a class="more-link btn btn-transparent" href="' . esc_url( get_permalink() ) . '">' .  sprintf( esc_html__( '%s', 'rock-star' ) , $more_tag_text ) . '</a></span>';
	}
