 ...
 * @since Rock Star 0.3
 */
function rock_star_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 * @since Rock Star 0.3
 */
function rock_star_sanitize_custom_css( $input ) {
	if ( '' != $input  ) {
 ...
 */
function rock_star_sanitize_image( $image, $setting ) {
	/*
 ...
 * @since Rock Star 0.3
 */
function rock_star_sanitize_page( $input ) {
 ...
 * @since Rock Star 0.3
 */
function rock_star_sanitize_category_list( $input ) {
	if ( '' != $input  ) {
		$args = array(
						'type'			=> 'post',
						'child_of'      => 0,
 ...
 *                    the setting default.
 */
function rock_star_sanitize_number_range( $number, $setting ) {
 ...
 *
 * @see rock_star_sanitize_select()               https://developer.wordpress.org/reference/functions/rock_star_sanitize_select/
 ...
 */
function rock_star_sanitize_select( $input, $setting ) {
